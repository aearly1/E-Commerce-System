...
{
    public partial class Register_Vendor : System.Web.UI.Page
    {
        ...
        protected void Registration(object sender, EventArgs e)
        {
            ...
            if (firstname != "" && lastname != "" && username != "" && password != "" && email != "" && company!="" && bank!="")
            {
            ...
            try
            {
                ...
                cmd.ExecuteNonQuery();
                conn.Close();
                Response.Write("<script>alert('Registration Successful as a Vendor');</script>");
