<%@ Page Language="C#" AutoEventWireup="true" CodeFile="postProduct.aspx.cs" Inherits="Mashroo3Qa3edetTa5zeenMa3loomat.postProduct" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="Add_item_button" runat="server" Text="Post Product" OnClick ="ProductPosting" CssClass="auto-style2" />
        <asp:Button ID="Home_redirector" runat="server" Text="Home" OnClick ="redirectToVendorHome" 
        style="z-index: 1; left: 200px; top: 253px; position: absolute" />
