    ...
    public partial class RemoveItem : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string wishList = (string)Session["wishList"];
                ...
                while (rdr.Read())
                {
                    ...
                    wishList_Button.Text = "Remove item" + serial_no + " from the wishlist";
                    wishList_Button.Attributes.Add("style", "left: 1150px; position: absolute;");
        ...
        protected void removeFromWishList(Object sender,EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.ExecuteNonQuery();
                conn.Close();
                Response.Write("<script>alert('Successfully removed the item from the wishlist')</script>");
                Response.Write("<script>location.href='RemoveFromWishList.aspx'</script>");
